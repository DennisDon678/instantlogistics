    ...
    return (
        ...
        >
            ...
            <div className="w-full max-w-xl mt-8 flex items-center gap-2 bg-primary p-2 rounded-xl border border-white/20">
                ...
                <SearchIcon />
                {/* input */}
                <input type="text" placeholder="Enter tracking number" className="w-full px-4 py-2 placeholder:text-white/50 text-white focus:outline-none" />
                {/* button */}
                <button className="px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Track</button>
            </div>
        </div>
    )
}
