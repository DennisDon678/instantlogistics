        ...
        <div className="lg:col-span-2 flex flex-col gap-2 rounded-xl border border-white/10 p-6 bg-white/5">
            <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-1">
                    <p className="text-green-400 text-base font-medium leading-normal">+12.5%</p>
                </div>
            </div>
                ...
                <svg fill="none" height="100%" preserveAspectRatio="none" viewBox="0 0 472 150" width="100%" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                        <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_chart" x1="236" x2="236" y1="1" y2="149">
                            <stop stopColor="#258cf4" stopOpacity="0.4" />
                            <stop offset="1" stopColor="#258cf4" stopOpacity="0" />
                        </linearGradient>
                    </defs>
                </svg>
            </div>
